            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                    {featuredProjects.map((project, index) => {
                        // Get animation class based on index, cycling through available animations
                        const animationClass = projectAnimations[index % projectAnimations.length];
                        ...
                        return (
                            <motion.div
                                ...
                                whileHover={{ y: -5 }}
                                className={`group animate__animated ${animationClass}`}
